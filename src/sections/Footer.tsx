...
const socials = [
  { icon: GithubIcon,   href: personalInfo.github,            label: "GitHub", sub: "REPOSITORY_NETWORK_ACTIVE", color: "#38bdf8" },
  { icon: LinkedinIcon, href: personalInfo.linkedin,          label: "LinkedIn", sub: "PROFESSIONAL_NETWORK_SYNCED", color: "#8b5cf6" },
