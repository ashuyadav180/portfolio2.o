...
export default function ContactSection() {
  ...
  const socials = [
    { icon: GitBranch, label: "GitHub Network", sub: "Repository Network Active", href: personalInfo.github, color: "#38bdf8" },
    { icon: ExternalLink, label: "LinkedIn Port", sub: "Professional Network Synced", href: personalInfo.linkedin, color: "#8b5cf6" },
          ...
          >
            ...
            <div className="glass-strong rounded-3xl p-6 border border-white/8 shadow-[0_15px_40px_rgba(0,0,0,0.55)] relative overflow-hidden group">
              ...
              <div className="space-y-4">
                {[
                  { icon: Mail, label: "COMMUNICATIONS_ROUTE", val: personalInfo.email, color: "#38bdf8" },
